    ...
    <div className="mt-4 space-y-4 rounded-2xl border border-white/60 bg-white/55 px-5 py-4 shadow-[0_24px_60px_-36px_rgba(24,39,79,0.35)]">
      ...
      <div className="flex flex-wrap gap-3">
        <button
          ...
          disabled={disabled}
          className={`rounded-full border px-4 py-2 text-xs font-semibold uppercase tracking-[0.22em] transition hover:scale-[1.01] ${wishlist
        ...
        <button
          ...
          disabled={disabled}
          className={`rounded-full border px-4 py-2 text-xs font-semibold uppercase tracking-[0.22em] transition hover:scale-[1.01] ${favorite
        ...
        <button
          ...
          disabled={disabled}
          className={`rounded-full border border-[#1d2742] bg-[#1d2742] px-4 py-2 text-xs font-semibold uppercase tracking-[0.22em] text-white shadow-[0_22px_48px_-28px_rgba(19,28,46,0.55)] transition hover:scale-[1.01] ${disabled ? "opacity-60" : ""
            }`}
        >
          Log visit
        </button>
